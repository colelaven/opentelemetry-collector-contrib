...
const file_secops_http_proto_rawDesc = "" +
	"\n" +
	"\x11secops_http.proto\x12\x14googlesecopsexporter\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcc\x03\n" +
	"\x03Log\x12\x12\n" +
	...
	"\x06labels\x18\x06 \x03(\v2%.googlesecopsexporter.Log.LabelsEntryR\x06labels\x1a]\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x128\n" +
	"\x05value\x18\x02 \x01(\v2\".googlesecopsexporter.Log.LogLabelR\x05value:\x028\x01\x1aC\n" +
	"\bLogLabel\x12\x14\n" +
	...
	"\rinline_source\x18\x02 \x01(\v28.googlesecopsexporter.ImportLogsRequest.LogsInlineSourceH\x00R\finlineSource\x12\x12\n" +
	"\x04hint\x18\x04 \x01(\tR\x04hint\x1a\x88\x01\n" +
	"\x10LogsInlineSource\x12-\n" +
	"\x04logs\x18\x01 \x03(\v2\x19.googlesecopsexporter.LogR\x04logs\x12\x1c\n" +
	"\tforwarder\x18\x02 \x01(\tR\tforwarder\x12'\n" +
	"\x0fsource_filename\x18\x03 \x01(\tR\x0esourceFilenameB\b\n" +
	"\x06sourceBlZjgithub.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlesecopsexporter/internal/proto/apib\x06proto3"
...
var file_secops_http_proto_goTypes = []any{
	(*Log)(nil),               // 0: googlesecopsexporter.Log
	(*ImportLogsRequest)(nil), // 1: googlesecopsexporter.ImportLogsRequest
	nil,                       // 2: googlesecopsexporter.Log.LabelsEntry
	(*Log_LogLabel)(nil),      // 3: googlesecopsexporter.Log.LogLabel
	(*ImportLogsRequest_LogsInlineSource)(nil), // 4: googlesecopsexporter.ImportLogsRequest.LogsInlineSource
	(*timestamppb.Timestamp)(nil),              // 5: google.protobuf.Timestamp
}
var file_secops_http_proto_depIdxs = []int32{
	5, // 0: googlesecopsexporter.Log.log_entry_time:type_name -> google.protobuf.Timestamp
	5, // 1: googlesecopsexporter.Log.collection_time:type_name -> google.protobuf.Timestamp
	2, // 2: googlesecopsexporter.Log.labels:type_name -> googlesecopsexporter.Log.LabelsEntry
	4, // 3: googlesecopsexporter.ImportLogsRequest.inline_source:type_name -> googlesecopsexporter.ImportLogsRequest.LogsInlineSource
	3, // 4: googlesecopsexporter.Log.LabelsEntry.value:type_name -> googlesecopsexporter.Log.LogLabel
	0, // 5: googlesecopsexporter.ImportLogsRequest.LogsInlineSource.logs:type_name -> googlesecopsexporter.Log
